...
?>
<div class="wrap">
<h2><?php echo $themename; ?> Theme Options | <a href="https://flexithemes.com/support/" target="_blank" style="font-size: 14px;">FlexiThemes.com <strong>Support</strong></a></h2>
...
<div id="buy_theme" class="updated" style="padding: 10px; margin: 10px;">You can buy this theme without footer links online at <a href="https://flexithemes.com/buy/?theme=<?php echo $buy_theme_name; ?>" target="_blank">https://flexithemes.com/buy/?theme=<?php echo $buy_theme_name; ?></a></div>
<form method="post">
