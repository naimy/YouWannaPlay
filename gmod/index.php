...
{
	echo '<audio autoplay id="audio" src="music/music.mp3" controls="controls">Your browser does not support the audio element.</audio>';
	echo '<script>elementaudio =jQuery(document).ready(function($) {$("#audio").volume=0.5;</script>';
