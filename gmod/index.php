...
{
	echo '<audio id="audio" src="music/music.mp3" controls="controls">Your browser does not support the audio element.</audio>';
	echo '<script>elementaudio = getELementById("audio");elementaudio.volume=0.5;</script>';
